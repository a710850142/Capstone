...
<template>
  ...
  <div class="stbox">
    ...
    <el-breadcrumb separator-class="el-icon-arrow-right">
      ...
      <el-breadcrumb-item>Total number of orders</el-breadcrumb-item>
    </el-breadcrumb>
    <!-- 搜索，切换 -->
   
    <!-- 统计图 -->
    <el-row :gutter="46">
      <el-col :span="23" class="text-c">
        <div class="paybox">
  ...
  data() {
    return {
      ...
      Clickoption: {
        ...
        legend: {
          data: [{
            name: 'Medication usage statistics',
            icon: 'rect'
          }],
          top: 1,
          left: 1,
      ...
      payoption: {
        ...
        title: {
          text: 'Pet classification statistics',
          left: 10,
          top: 5,
          textStyle: {
            fontSize: 12,
        ...
        series: [
          {
            name: 'Pet classification statistics',
            type: 'pie',
            radius: '55%',
            center: ['50%', '50%'],
      ...
      payNumoption: {
        backgroundColor: '#2c343c',
        title: {
          text: 'Therapeutic drug statistics',
          left: 10,
          top: 5,
          textStyle: {
            fontSize: 12,
        ...
        series: [
          {
            name: 'Therapeutic drug statistics',
            type: 'pie',
            radius: '55%',
            center: ['50%', '50%'],
            data: [
    ...
    getSCE() {
      ...
      tj()
        .then(res => {
          ...
          this.SCEoption.series[0].data=res.l1
    ...
    getSUM() {
      ...
      tj()
        .then(res => {
          ...
          this.SUMoption.series[0].data=res.l2
    ...
    getClick() {
      ...
      tj()
        .then(res => {
          ...
          this.Clickoption.series[0].data=res.l4
    ...
    getpay() {
      ...
      tj()
        .then(res => {
          ...
          this.payoption.series[0].data=res.l2
          console.log(this.payoption.series[0].data);
          console.log("12312312344");
          console.log(this.payoption.series[0].itemStyle.normal.color);
    ...
    getpayNum() {
      ...
      tj()
        .then(res => {
          ...
          //this.payNumoption.series[0].data=res.l5
          this.payNumoption.series[0].data = res.l4
          console.log(this.payNumoption);
          this.payNumoption.series[0].itemStyle.normal.color='#c23531'
