  ...
  data() {
    return {
      ...
      Clickoption: {
        ...
        legend: {
          data: [{
            name: 'Statistics of medication usage',
            icon: 'rect'
          }],
          top: 1,
          left: 1,
      ...
      payoption: {
        ...
        title: {
          text: 'Statistics of pet categories',
          left: 10,
          top: 5,
          textStyle: {
            fontSize: 12,
        ...
        series: [
          {
            name: 'Statistics of pet categories',
            type: 'pie',
            radius: '55%',
            center: ['50%', '50%'],
    ...
    getpay() {
      ...
      tj()
        .then(res => {
          ...
          this.payoption.series[0].data=res.l3
          console.log(this.payoption.series[0].data);
